...
namespace EntityOrnek {
    ...
    public partial class KayitDataSet : global::System.Data.DataSet {
        ...
        public partial class musteriDataTable : global::System.Data.TypedTableBase<musteriRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public musteriRow AddmusteriRow(string adi, string soyadi, string sehir, string adres) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public musteriRow FindByid(decimal id) {
        ...
        public partial class musteriRow : global::System.Data.DataRow {
            ...
            public decimal id {
                get {
                    return ((decimal)(this[this.tablemusteri.idColumn]));
                }
                set {
...
namespace EntityOrnek.KayitDataSetTableAdapters {
    ...
    public partial class musteriTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[musteri] ([adi], [soyadi], [sehir], [adres]) VALUES (@adi, @so" +
                "yadi, @sehir, @adres);\r\nSELECT id, adi, soyadi, sehir, adres FROM musteri WHERE " +
                "(id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[musteri] SET [adi] = @adi, [soyadi] = @soyadi, [sehir] = @sehir, [adres] = @adres WHERE (([id] = @Original_id) AND ((@IsNull_adi = 1 AND [adi] IS NULL) OR ([adi] = @Original_adi)) AND ((@IsNull_soyadi = 1 AND [soyadi] IS NULL) OR ([soyadi] = @Original_soyadi)) AND ((@IsNull_sehir = 1 AND [sehir] IS NULL) OR ([sehir] = @Original_sehir)) AND ((@IsNull_adres = 1 AND [adres] IS NULL) OR ([adres] = @Original_adres)));
SELECT id, adi, soyadi, sehir, adres FROM musteri WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EntityOrnek.Properties.Settings.Default.KayitConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, adi, soyadi, sehir, adres FROM dbo.musteri";
        ...
        public virtual int Fill(KayitDataSet.musteriDataTable dataTable) {
        ...
        public virtual KayitDataSet.musteriDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            KayitDataSet.musteriDataTable dataTable = new KayitDataSet.musteriDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(KayitDataSet.musteriDataTable dataTable) {
        ...
        public virtual int Delete(decimal Original_id, string Original_adi, string Original_soyadi, string Original_sehir, string Original_adres) {
        ...
        public virtual int Insert(string adi, string soyadi, string sehir, string adres) {
            if ((adi == null)) {
        ...
        public virtual int Update(string adi, string soyadi, string sehir, string adres, decimal Original_id, string Original_adi, string Original_soyadi, string Original_sehir, string Original_adres, decimal id) {
            if ((adi == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string adi, string soyadi, string sehir, string adres, decimal Original_id, string Original_adi, string Original_soyadi, string Original_sehir, string Original_adres) {
            return this.Update(adi, soyadi, sehir, adres, Original_id, Original_adi, Original_soyadi, Original_sehir, Original_adres, Original_id);
        }
    }
